        ...
        <div class="video-comment">
            ...
            <div class="video-container">
                ...
                while ($row = mysqli_fetch_assoc($select_video)) {
                    ...
                    $video_thumbnail = $row['url'];
                    // $video_description = $row['vDescription'];
                    $uploaded_date = $row['date'];

                ?>

                   <iframe src="<?php echo $video_thumbnail?>" height="500" ></iframe>
                    ...
                    <div class="header" style="margin-bottom:10px">
                        <div class="title-date">
                            ...
                            <div class="like-dislike">
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <i <?php if (userLiked($row['liveVideoId'])) : ?> class="fa fa-thumbs-up like-btn" <?php else : ?> class="fa fa-thumbs-o-up like-btn" <?php endif ?> data-id="<?php echo $row['liveVideoId'] ?>"></i>
                                <span class="likes"><?php echo getLikes($row['liveVideoId']); ?></span>
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <i <?php if (userDisliked($row['liveVideoId'])) : ?> class="fa fa-thumbs-down dislike-btn" <?php else : ?> class="fa fa-thumbs-o-down dislike-btn" <?php endif ?> data-id="<?php echo $row['liveVideoId'] ?>"></i>
                                <span class="dislikes"><?php echo getDislikes($row['liveVideoId']); ?></span>
                            </div>
                        </div>
