...
<body>
    ...
    <div class="main-section">
        <div class="video-comment">
            ...
            <div class="video-container">
                ...
                $query = "SELECT *FROM videos  WHERE videoId = $vid ORDER BY date DESC LIMIT 3";
                ...
                ?>
                    ...
                    <video src="../admin/admin_videos/<?php echo $video_thumbnail ?>" autoplay controls style="width: 100%; height: 500px;"></video>
                    ...
                    <div class="header" style="margin-bottom:10px">
                        <div class="title-date">
                            ...
                            <div class="like-dislike">
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <i <?php if (userLiked($row['videoId'])) : ?> class="fa fa-thumbs-up like-btn" <?php else : ?> class="fa fa-thumbs-o-up like-btn" <?php endif ?> data-id="<?php echo $row['videoId'] ?>"></i>
                                <span class="likes"><?php echo getLikes($row['videoId']); ?></span>
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <i <?php if (userDisliked($row['videoId'])) : ?> class="fa fa-thumbs-down dislike-btn" <?php else : ?> class="fa fa-thumbs-o-down dislike-btn" <?php endif ?> data-id="<?php echo $row['videoId'] ?>"></i>
                                <span class="dislikes"><?php echo getDislikes($row['videoId']); ?></span>
    ...
    <h3 style="margin-top: 60px; margin-left:20px;">Related Videos</h3>
